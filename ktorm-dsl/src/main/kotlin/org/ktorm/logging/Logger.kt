 ...
 *
 * By default, Ktorm auto detects a logging implementation from the classpath while creating [Dsl] instances.
 * If you want to output logs using a specific logging framework, you can choose an adapter implementation of this
 * interface and explicitly set the [Dsl.logger] property.
 *
